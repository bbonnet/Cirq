...
from cirq.linalg.tolerance import all_close, all_near_zero, all_near_zero_mod, close, near_zero, near_zero_mod
...
def test_all_zero_mod():
    ...
    assert all_near_zero_mod([-4.5, 0, 1, 4.5, 3, 95.5, 104.5], 100, atol=atol, rtol=rtol)
    assert not all_near_zero_mod([-4.5, 0, 1, 4.5, 30], 100, atol=atol, rtol=rtol)
