...
from cirq.linalg.tolerance import DEFAULT_RTOL, DEFAULT_ATOL, all_near_zero, all_close
...
def is_orthogonal(
    ...
    return (matrix.shape[0] == matrix.shape[1] and
            ...
            all_close(matrix.dot(matrix.T), np.eye(matrix.shape[0]), rtol=rtol, atol=atol))
